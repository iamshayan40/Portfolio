  ...
  return (
    <nav className="w-full flex items-center justify-between px-4 py-3 md:px-8 md:py-4 bg-transparent">
      ...
      <a
        ...
        className="group flex items-center border border-zinc-400 rounded-full px-5 py-1.5 md:px-6 md:py-1.5 transition-all duration-300 hover:bg-[#24292f] hover:border-[#24292f] hover:scale-105 focus:outline-none"
        style={{
          boxShadow: '0 2px 8px rgba(255,255,255,0.05)',
          backdropFilter: 'blur(2px)',
        }}
      >
        <span className="text-white font-light text-[15px] md:text-[14px] transition-colors duration-300 flex items-center gap-2" style={{fontFamily: 'lexend'}}>
          Github
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
            className="w-4 h-4 transition-colors duration-300 group-hover:text-[#fff] group-hover:bg-[#24292f] rounded-full"
